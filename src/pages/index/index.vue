<template>
	<tabbar></tabbar>
	<view class="content">
		<up-swiper :list="list1" class="swiper"></up-swiper>
		<view class="signIn_View">
			<view class="love">
				<view style="display: flex;flex-direction: row;align-items: center;">
					<up-image style="margin-right: 15rpx;" src="../../static/icon/love.png" width="32px"
						height="32px"></up-image>
					<span>我的爱心</span>
				</view>
				<view>
					<span>0</span>
			...
			<view class="location">
				<up-image style="margin-right: 15rpx;" src="../../static/icon/map.png" width="32px"
					height="32px"></up-image>
		...
		<view class="square_card">
			...
			<view class="square_card_content">
				<view>
					<up-image style="margin-right: 15rpx;" shape="circle" src="../../static/card/male.png" width="52px"
						height="52px"></up-image>
				...
				<view style="display: flex;flex-direction: column;width: 100%;">
					...
					<view class="square_card_content_img">
						<up-image style="margin-right: 5rpx;" src="../../static/card/male.png" class="squareImage"
							width="100px" height="100px"></up-image>
						<up-image style="margin-right: 5rpx;" src="../../static/card/male.png" class="squareImage"
							width="100px" height="100px"></up-image>
						<up-image style="margin-right: 5rpx;" src="../../static/card/male.png" class="squareImage"
							width="100px" height="100px"></up-image>
...
<style scoped>
	.content {
		...
		overflow: hidden;
		margin-top: 20rpx;
		background-image: url(../../static/Rectangle 148.svg);
	}
